...
Scenario: Availability manager user should be able to modify the pricing of units both in bulk pricing page and per unit.
  ...
  Given I am on "admin/rooms/units/bulk_pricing_management/2016/5"
  Then I click "Update Pricing"
  And I fill in "rooms_start_date[date]" with "19/05/2016"
  And I fill in "rooms_end_date[date]" with "23/05/2016"
  ...
  Then the price for "Normal" between "2016-05-19" and "2016-05-23" should be "150"
  And the price for "Special" between "2016-05-19" and "2016-05-23" should be "160"
  ...
  Then the price for "Normal" between "2016-05-19" and "2016-05-23" should be "200"
  And the price for "Special" between "2016-05-19" and "2016-05-23" should be "210"
  ...
  Then the price for "Normal" between "2016-05-19" and "2016-05-23" should be "170"
  And the price for "Special" between "2016-05-19" and "2016-05-23" should be "180"
  ...
  Then the price for "Normal" between "2016-05-19" and "2016-05-23" should be "120"
  And the price for "Special" between "2016-05-19" and "2016-05-23" should be "130"
  ...
  Then the price for "Normal" between "2016-05-19" and "2016-05-23" should be "150"
  And the price for "Special" between "2016-05-19" and "2016-05-23" should be "150"
  ...
  Then the price for "Normal" between "2016-05-19" and "2016-05-23" should be "180"
  And the price for "Special" between "2016-05-19" and "2016-05-23" should be "180"
  ...
  Then the price for "Normal" between "2016-05-19" and "2016-05-23" should be "144"
  And the price for "Special" between "2016-05-19" and "2016-05-23" should be "144"

  # Check the day of the week select boxes.
  Given I am on "admin/rooms/units/bulk_pricing_management/2016/5"
  Then I click "Update Pricing"
  And I fill in "rooms_start_date[date]" with "19/05/2016"
  And I fill in "rooms_end_date[date]" with "21/05/2016"
  And I select "Replace price" from "operation"
  ...
  Then the price for "Normal" between "2016-05-19" and "2016-05-21" should be "120"
  And the price for "Special" between "2016-05-19" and "2016-05-21" should be "120"
  And the price for "Normal" between "2016-05-22" and "2016-05-23" should be "144"
  And the price for "Special" between "2016-05-22" and "2016-05-23" should be "144"

  # Check the single unit price management page.
  Given I am managing the "Normal" unit pricing
  Then I click "Update Unit Pricing"
  And I fill in "rooms_start_date[date]" with "29/05/2016"
  And I fill in "rooms_end_date[date]" with "23/06/2017"
  And I select "Replace price" from "operation"
  And I fill in "amount" with "150"
  And I press the "Update Unit Pricing" button

  Then the price for "Normal" between "2016-05-29" and "2017-06-23" should be "150"
