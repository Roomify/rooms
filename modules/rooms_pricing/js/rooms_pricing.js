...
Drupal.behaviors.rooms_availability = {
  attach: function(context) {
    ...
    $('#calendar').fullCalendar({
      ...
      events: Drupal.settings.basePath + 'admin/rooms/units/unit/' + Drupal.settings.roomID + '/pricing/json/' + $currentyear + '/' + $currentmonth
    });
    ...
    $('#calendar1').fullCalendar({
      ...
      events: Drupal.settings.basePath + 'admin/rooms/units/unit/' + Drupal.settings.roomID + '/pricing/json/' + $nextyear1 + '/' + $nextmonth1
    });
    ...
    $('#calendar2').fullCalendar({
      ...
      events: Drupal.settings.basePath + 'admin/rooms/units/unit/' + Drupal.settings.roomID + '/pricing/json/' + $nextyear2 + '/' + $nextmonth2
    });
